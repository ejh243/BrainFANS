...
sczLoci<-read.csv(file.path(args[3], "SCZ_CNVloci.csv"), skip = 1, stringsAsFactors = FALSE)
...
write.csv(output, file.path(dirname(fileName), "CNVsoverlappingKnownSCZRiskLoci.csv"))
...
idLoci<-read.csv(file.path(args[3], "IDCNVLoci.csv"), stringsAsFactors = FALSE)
...
output<-rbind(data.frame(overlapDel), data.frame(overlapDup))
write.csv(output, file.path(dirname(fileName), "CNVsoverlappingIDRiskLoci.csv"))
```
...
pathLoci<-read.table(file.path(args[3], "PathogenicCNVLoci.txt"), stringsAsFactors = FALSE, sep = "\t", header = TRUE)
...
output<-rbind(data.frame(overlapDel), data.frame(overlapDup))
write.csv(output, file.path(dirname(fileName), "CNVsoverlappingPathogenicCNV.csv"))
