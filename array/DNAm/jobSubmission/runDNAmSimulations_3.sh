...
#SBATCH --error=LogFiles/EWAS_Sims_3.err # error file
#SBATCH --output=LogFiles/EWAS_Sims_3.log # output file
...
Rscript DNAm/EWAS/Simulations/EWASSimulations.r DNAm/rmdConfig.mrc 5 
Rscript DNAm/EWAS/Simulations/EWASSimulations.r DNAm/rmdConfig.mrc 6
