...
```{r,echo = FALSE}
  ...
  for(element in predictedduplicates){
	...
	write.csv(QCmetrics[errorIndexes,], "QCMetrics/GeneticMismatches.csv", row.names = FALSE)
	}
...
write.csv(QCmetrics[which(as.character(QCmetrics$predSex) != as.character(QCmetrics$Sex)),], "QCMetrics/SexMismatches.csv", row.names = FALSE)
```
