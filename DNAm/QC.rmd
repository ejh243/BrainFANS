...
plotCols<-data.frame("Plate Location" = colLocation, "Extraction Plate" = colExtraction,  "Chip ID" = colChip, "Chip Position" = colPosition, "Individual" = colIndividual, "Cell type" = colCellType, "Sort Date" = colSortDate, "Schizophrenia Status" = colPheno, "Sex" = colSex, stringsAsFactors = FALSE)
