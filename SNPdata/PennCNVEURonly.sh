...
cd PennCNVInput/
${PENNCNVPATH}/detect_cnv.pl --test -hmm ${PENNCNVPATH}/lib/hh550.hmm -pfb ${PENNCNVPATH}/pfb/gsa.gr38.eur.pfb --listfile ../../EURSamples.txt -log ../PennCNVOutput/EURonly/SCZ2.log -out ../PennCNVOutput/EURonly/SCZ_GCModel.rawcnv -gcmodel ${PENNCNVPATH}/lib/GSA.gcmodel;
