...
```{r hists, fig.align = 'center', echo=FALSE}
...
```{r covhist, fig.align = 'center', echo=FALSE, warning=FALSE, results=FALSE}
...
```{r ssd, fig.align = 'center', fig.height = 10, echo=FALSE, warning=FALSE, results=FALSE}
...
```{r cc, fig.align = 'center', echo=FALSE, warning=FALSE, results=FALSE}
...
```{r peakProf, fig.align = 'center', echo=FALSE, warning=FALSE, results=FALSE}
...
```{r relativeEnrich, fig.align = 'center', echo=FALSE, warning=FALSE, results=FALSE}
...
```{r fripfribl, fig.align = 'center', echo=FALSE, warning=FALSE, results=FALSE}
...
``` {r cluster, fig.align = 'center', echo=FALSE, warning=FALSE, results=FALSE}
plotCorHeatmap(dat,attributes=c("Tissue","Factor"))
dba.plotPCA(dat,attributes=c("Tissue", "Factor"))
```