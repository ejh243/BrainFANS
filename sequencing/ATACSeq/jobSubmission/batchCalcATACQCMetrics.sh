...
#SBATCH --output=LogFiles/ATAC/calcATACQC-%A_%a.o
#SBATCH --error=LogFiles/ATAC/calcATACQC-%A_%a.e
...
mv LogFiles/ATAC/calcATACQC-${SLURM_ARRAY_JOB_ID}* LogFiles/ATAC/${SLURM_ARRAY_JOB_ID}
