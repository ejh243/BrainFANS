...
#SBATCH --output=/lustre/projects/Research_Project-MRC190311/scripts/sequencing/ATACSeq/logFiles/%u/ATACAlignment-%A_%a.o
#SBATCH --error=/lustre/projects/Research_Project-MRC190311/scripts/sequencing/ATACSeq/logFiles/%u/ATACAlignment-%A_%a.e
