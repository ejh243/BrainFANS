...
#SBATCH --job-name=groupATACPeakCalling
...
FILES=("${QC1SAMPLES[@]/%/.filt.nodup.bam}")

if [ $# == 1 ] || [[ $2 =~ 'PEAK' ]]
then
	mkdir -p ${PEAKDIR}/MACS/BAMPE/subset
...
then
  ...
  module load SAMtools
	...
	sh ./ATACSeq/preprocessing/calcFripGroup_BAMPE.sh ${QC1SAMPLES[@]}
fi
