...
``` {r minReads, fig.align = 'center', dpi = 500, echo=FALSE}
...
``` {r uniqueReads, fig.align = 'center', dpi = 500, echo=FALSE}
...
legend('bottomright', legend = unique(pheno$fraction), 
...
abline(h = 95, lty = 2) #ideal
abline(h = 80, lty = 2, col = colorBlindGrey8[1]) #acceptable
#text(mergeStats[,"paired_total"], mergeStats[,"overall_alignment_rate"], labels = pheno$sampleID)
```


``` {r blank, fig.align = 'center', dpi = 500, echo = FALSE}
...
``` {r mitochondria, fig.align = 'center', dpi = 500, echo = FALSE}
par(mfrow = c(1,1))
...
``` {r dedupreads, fig.align = 'center', dpi = 500, echo = FALSE}
...
``` {r encode, fig.align = 'center', dpi = 500, echo=FALSE}
par(mfrow = c(3,1))
...
``` {r correlation, fig.align = 'center', dpi = 500, echo=FALSE}
...
``` {r periodicity, fig.align = 'center', dpi = 500, echo = FALSE}
## load ATACQC metrics 
...
```{r numpeaks, echo = FALSE, fig.width = 10, fig.height = 6, dpi=500}
par(mfrow = c(1, 1))
vioplot(fripStats$MACS2TagAlignPeaks, fripStats$MACS2PEPeaks, ylab = "Number of peaks", names = c("MACS2: Shifted tagalign", "MACS2: PE"))
abline(h = 150000, lty = 2)
abline(h = 100000, lty = 2, col = colorBlindGrey8[1]) #acceptable
```
...
```{r, echo = FALSE, dpi = 500, fig.width = 10, fig.height = 6, fig.cap="Figure X: Proportion of reads in called peaks"}
# plot 
par(mfrow = c(1, 1))
...
abline(h = 0.3, lty = 2) #ideal
abline(h = 0.2, lty = 2, col = colorBlindGrey8[1]) #acceptable
