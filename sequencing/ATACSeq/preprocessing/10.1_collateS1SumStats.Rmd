...
```{r pressure, fig.align = 'center', dpi = 100, echo=FALSE}
par(mfrow = c(2,2))
...
``` {r uniqueReads, fig.align = 'center', dpi = 100, echo=FALSE}
...
legend('bottomright', legend = c('Total', 'NeuN', 'Sox10', 'Neg'), 
       fill = colorBlindGrey8[as.factor(pheno$fraction)],cex=0.8)
...
```{r alignment rate, fig.align = 'center', dpi = 100, echo = FALSE}
...
abline(h = 95, lty = 2)
abline(h = 80, lty = 2, col = colorBlindGrey8[1])
```

Figure 

``` {r blank, fig.align = 'center', dpi = 100, echo = FALSE}
