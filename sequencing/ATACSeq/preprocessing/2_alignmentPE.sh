...
if ls ${TRIMDIR}/${sampleName}*[rR]1*_trimmed.f* 1> /dev/null 2>&1;
then 
  f1=$(basename $(ls ${TRIMDIR}/${sampleName}*[rR]1*_trimmed.f*))
  f2=$(basename $(ls ${TRIMDIR}/${sampleName}*[rR]2*_trimmed.f*))
else
  f1=$(basename $(ls ${TRIMDIR}/${sampleName}*_trimmed_[rR]1*.f*))
  f2=$(basename $(ls ${TRIMDIR}/${sampleName}*_trimmed_[rR]2*.f*))
fi
