...
#PBS -l walltime=60:00:00 # Maximum wall time for the job.
...
#PBS -e LogFiles/ChipAlignmentADRun2.err # error file
#PBS -o LogFiles/ChipAlignmentADRun2.log # output file
