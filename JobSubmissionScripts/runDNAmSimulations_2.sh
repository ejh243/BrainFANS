...
#PBS -e LogFiles/EWAS_Sims_2.err # error file
#PBS -o LogFiles/EWAS_Sims_2.log # output file
...
Rscript DNAm/EWAS/Simulations/NullSimulationsPerFraction.r DNAm/rmdConfig.mrc 
