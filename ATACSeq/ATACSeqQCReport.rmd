...
```{r, plotUniquenessCurve, echo = FALSE, fig.height = 6, fig.width = 8, fig.caption = "Figure 1: Line graph of number of unique reads (y-axis) as number of reads (x-axis) increases.", message = FALSE,results='hide'}
