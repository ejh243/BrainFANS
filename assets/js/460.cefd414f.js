...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/sankeyDiagram-a04cb91d.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_7ea9cbd6.e.sanitizeText(ID, (0,mermaid_7ea9cbd6.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_7ea9cbd6.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_7ea9cbd6.c)();
  const defaultSankeyConfig = mermaid_7ea9cbd6.K.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,mermaid_7ea9cbd6.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
