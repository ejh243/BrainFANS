...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.L;
...
const draw = function(text, id, version, diagObj) {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("timeline", diagObj.db);
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskHeight before draw", taskHeight);
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf);
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionNode output", node);
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.o)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  ...
  for (const task of tasks2) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf);
    const taskHeight = node.height;
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskHeight after draw", taskHeight);
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf) {
  ...
  for (const event of events) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("eventNode", eventNode);
...
const genSections = (options) => {
  ...
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    ...
    if ((0,khroma__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(options["lineColor" + i])) {
      options["lineColor" + i] = (0,khroma__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(options["lineColor" + i], 20);
    } else {
      options["lineColor" + i] = (0,khroma__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(options["lineColor" + i], 20);
    }
  }
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
