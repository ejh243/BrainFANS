...
/* harmony export */ });
/* harmony import */ var _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5721);
...
/* harmony import */ var _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(782);
/* harmony import */ var _index_5325376f_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(294);
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.D) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(itemId, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.c)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeTextOrArray(newNode.description, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.c)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.a ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.b:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.D:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(item.description, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.c)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.c) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = async function(text, id, _version, diag) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  diag.db.getDirection();
  const { securityLevel, state: conf } = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.c)();
  const nodeSpacing = conf.nodeSpacing || 50;
  const rankSpacing = conf.rankSpacing || 50;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.info(diag.db.getRootDocV2());
  ...
  await (0,_index_5325376f_js__WEBPACK_IMPORTED_MODULE_9__.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
  const bounds = svg.node().getBBox();
  const width = bounds.width + padding * 2;
  const height = bounds.height + padding * 2;
  svg.attr("class", CSS_DIAGRAM);
  const svgBounds = svg.node().getBBox();
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.i)(svg, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_8__.l.debug(`viewBox ${vBox}`);
...
const diagram = {
  parser: _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.p,
  db: _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.d,
  renderer,
  styles: _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.s,
  init: (cnf) => {
    if (!cnf.state) {
      cnf.state = {};
    }
    cnf.state.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_7__.d.clear();
  }
};
...
/* harmony export */ });
/* harmony import */ var _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(782);
...
const setRootDoc = (o) => {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Setting root doc", o);
  rootDoc = o;
};
  ...
  if (node.stmt === STMT_RELATION) {
    ...
    if (node.doc) {
      ...
      if (doc.length > 0 && currentDoc.length > 0) {
        const newNode = {
          stmt: STMT_STATE,
          id: (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.I)(),
          type: "divider",
...
const extract = (_doc) => {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info(doc);
  clear(true);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Extract", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
        addState(
...
const addState = function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles2 = null, textStyles = null) {
  ...
  if (currentDocument.states[trimmedId] === void 0) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Adding state ", trimmedId, descr);
  ...
  if (descr) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Setting state description", trimmedId, descr);
  ...
  if (note) {
    ...
    currentDocument.states[trimmedId].note.text = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(
      currentDocument.states[trimmedId].note.text,
      (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()
    );
  }
  if (classes2) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Setting state classes", trimmedId, classes2);
  ...
  if (styles2) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Setting state styles", trimmedId, styles2);
...
const clear = function(saveCommon) {
  ...
  if (!saveCommon) {
    (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.v)();
  }
};
...
const logDocuments = function() {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Documents = ", documents);
};
...
function addRelationObjs(item1, item2, relationTitle) {
  ...
  currentDocument.relations.push({
    id1,
    id2,
    relationTitle: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(relationTitle, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)())
  });
}
const addRelation = function(item1, item2, title) {
  if (typeof item1 === "object") {
    ...
    currentDocument.relations.push({
      id1,
      id2,
      title: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(title, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)())
    });
  }
};
const addDescription = function(id, descr) {
  ...
  theState.descriptions.push(_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(_descr, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()));
};
...
const db = {
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().state,
  addState,
  clear,
  getState,
  getStates,
  ...
  extract,
  trimColon,
  getAccTitle: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.g,
  setAccTitle: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.s,
  getAccDescription: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.a,
  setAccDescription: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.b,
  addStyleClass,
  setCssClass,
  addDescription,
  setDiagramTitle: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.q,
  getDiagramTitle: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.t
};
